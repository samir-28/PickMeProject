...
public class Fragement7 extends AppCompatActivity {

    Button add;
    ListView listViewData;
    ArrayAdapter<String> adapter;
    String[] array = { "Pasta", "Beans",
            "Cereals", "Oatmeal",
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.btn7_fragment);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder build=new AlertDialog.Builder(Fragement7.this);
                View v= LayoutInflater.from(Fragement7.this).inflate(R.layout.alert,null);
                build.setView(v);
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (valid()) {
                            ...
                            Datbasehelper help = new Datbasehelper(Fragement7.this);
                            help.insertdata(d);
                            Toast.makeText(Fragement7.this, "Data added successfully", Toast.LENGTH_SHORT).show();
                            alert.dismiss();
                            Intent i = new Intent(Fragement7.this, Fragement7.class);
                            startActivity(i);
                        }
                    }
        ...
        if (id == R.id.item_done) {
            ...
            for (int i = 0; i < listViewData.getCount();i++) {
                if (listViewData.isItemChecked(i)) {
                    ...
                    DataBaseHelper2 help=new DataBaseHelper2(Fragement7.this);
                    help.insertdata(d);
                }
            }
            Toast.makeText(this, "Items Selected Successfully", Toast.LENGTH_SHORT).show();
            Intent intent=new Intent(Fragement7.this,MenuList.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i=new Intent(Fragement7.this,MenuList.class);
        startActivity(i);
    }
}
